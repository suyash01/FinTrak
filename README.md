...
- **Auth**: short-lived JWT access tokens in httpOnly cookies plus server-recorded, rotating refresh sessions; refresh-token reuse and logout revoke the session family
