    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      <div className="w-full max-w-sm">
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="w-10 h-10 bg-linear-to-br from-cyan-500 to-violet-500 rounded-lg flex items-center justify-center text-white font-extrabold text-lg">F</div>
          <span className="text-2xl font-bold bg-linear-to-br from-cyan-500 to-violet-500 bg-clip-text text-transparent">FinTrak</span>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
          ...
          <p className="text-sm text-slate-500 mb-6">
            {mode === 'login' ? 'Sign in to continue to FinTrak' : 'Start tracking your finances in minutes'}
          </p>
