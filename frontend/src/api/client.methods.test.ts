...
describe("api method surface", () => {
  ...
  const cases: Case[] = [
    ...
    { name: "saveLoanSchedule", call: () => api.saveLoanSchedule("a1", { principal: 1000, annualRateBps: 0, tenureMonths: 12, startDate: "2024-01-01" }), url: "/accounts/a1/loan-schedule", method: "PUT" },
    ...
    { name: "getLinkCycles", call: () => api.getLinkCycles(), url: "/links/cycles", method: "GET" },
